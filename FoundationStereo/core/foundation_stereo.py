...
if __name__ == '__main__':
    ...
    img0, img1 = torch.randn(B, C, H, W).half().cuda(), torch.randn(B, C, H, W).half().cuda()
    
    x = model.forward(img0, img1, iters=args.valid_iters, test_mode=True)
