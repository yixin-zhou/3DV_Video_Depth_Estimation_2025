...
"""
演示脚本 (Demonstration Script)
该脚本提供了FoundationStereo模型的完整推理演示流程。
支持从单对立体图像预测视差图、生成深度图和3D点云，
并提供点云后处理和可视化功能，展示立体匹配的全部流程和结果。
"""
